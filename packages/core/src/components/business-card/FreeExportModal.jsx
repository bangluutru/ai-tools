...
export const FreeExportModal = ({
  ...
  >
    ...
    /* Header */
        ...
        <div className="px-6 py-4 border-b border-border-subtle/50 flex items-center justify-between bg-gradient-to-r from-brand-50 via-white to-indigo-50">
    ...
    /* Success Alert */
        ...
        {exportSuccessMsg && <div className="mx-6 mt-4 p-3 rounded-xl bg-emerald-50 border border-emerald-200 text-emerald-800 text-xs flex items-center gap-2 animate-in fade-in">
    ...
    /* Preflight status badge */
          ...
          {preflight && <div className="p-3.5 rounded-xl bg-surface-canvas border border-border-subtle flex items-center justify-between">
              <div className="flex items-center gap-2">
    ...
    /* 3 Core Features Grid */
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            <div className="p-4 rounded-xl border border-border-subtle bg-surface-container-high hover:border-brand-300 transition-colors">
    ...
    className="w-full py-3 px-4 rounded-xl bg-primary-container hover:bg-brand-700 text-white font-bold text-sm shadow-md shadow-brand-500/20 hover:shadow-lg transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
  >
              <FileText className="w-4 h-4" />
    ...
    className="w-full py-3 px-4 rounded-xl bg-slate-900 hover:bg-black text-white font-bold text-sm shadow-md hover:shadow-lg transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
  >
