...
const legalUiTranslations = {
    vn: {
        pasteLabel: 'Nhập Nội Dung Văn Bản (Raw Text)',
        appendBtn: 'Dịch bằng AI',
        ...
        empty: 'Vui lòng dán nội dung vào cột trái để dịch',
        errorPrefix: 'Lỗi: ',
        errorInvalid: 'Kết quả trả về không hợp lệ.',
        saving: 'Đang lưu...',
        saved: 'Đã lưu',
    ...
    en: {
        pasteLabel: 'Input Raw Text',
        appendBtn: 'Translate via AI',
        ...
        empty: 'Please paste raw text in the left column to start',
        errorPrefix: 'Error: ',
        errorInvalid: 'Invalid response from AI.',
        saving: 'Saving...',
        saved: 'Saved',
    ...
    jp: {
        ...
        placeholder: 'ここにテキストを貼り付けます...',
        empty: '左の列にテキストを貼り付けてください',
        errorPrefix: 'エラー: ',
        errorInvalid: 'AIからの無効な応答。',
        saving: '保存中...',
        saved: '保存済み',
                    ...
                    <div className="flex-grow overflow-y-auto p-4 space-y-4 custom-scrollbar">
                        ...
                        <section>
                            ...
                            <button
                                ...
                                disabled={!jsonInput.trim() || isTranslating}
                            ...
                            >
                                {isTranslating ? <Loader2 size={15} className="animate-spin" /> : <Sparkles size={15} />}
                                {t.appendBtn}
                            </button>
