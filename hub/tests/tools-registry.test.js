...
test('every miniapp has a valid product group defaulting safely to common', () => {
  ...
  assert.deepEqual(
    ...
    ['japan-tax-simulator', 'social-insurance-jp', 'social-insurance-eligibility-jp', 'national-pension-jp', 'dependent-insurance-jp', 'overtime-calculator-jp', 'paid-leave-checker-jp', 'unemployment-eligibility-jp', 'unemployment-benefit-jp'].sort(),
    'japan-life group contains japan-tax-simulator, social-insurance-jp, social-insurance-eligibility-jp, national-pension-jp, dependent-insurance-jp, overtime-calculator-jp, paid-leave-checker-jp, unemployment-eligibility-jp and unemployment-benefit-jp',
  );
