...
await workbook.xlsx.writeFile(path.join(outputDir, 'mock_supplier_template.xlsx'));
...
XLSX.writeFile(customerWb, path.join(outputDir, 'mock_customer_order.xlsx'));

console.log(`Mock Excel files created in ${outputDir}`);
